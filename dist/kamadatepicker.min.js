    ...
    function (t, e, o) {
        ...
        o(2),
            (window.kamaDatepicker = function (t, e) {
                if (-1 === ["string", "object"].indexOf(n(t)) || ("object" === n(t) && null === t) || ("strinf" == typeof t && 0 === t.length))
                    return void console.error("kamadatepicker error: input ID is not an object, string or is an empty strong!");
                var o,
                    a,
                    r,
                    i,
                ...
                (f.placeholder = void 0 !== f.placeholder ? f.placeholder : ""),
                    ...
                    (f.closeAfterSelect = void 0 === f.closeAfterSelect || f.closeAfterSelect),
                    (f.nextButtonIcon = void 0 !== f.nextButtonIcon && f.nextButtonIcon),
                    (f.previousButtonIcon = void 0 !== f.previousButtonIcon && f.previousButtonIcon),
                    (f.buttonsColor = void 0 !== f.buttonsColor && f.buttonsColor),
                    (f.forceFarsiDigits = void 0 !== f.forceFarsiDigits && f.forceFarsiDigits),
                    (f.markToday = void 0 !== f.markToday && f.markToday),
                    (f.markHolidays = void 0 !== f.markHolidays && f.markHolidays),
                    (f.highlightSelectedDay = void 0 !== f.highlightSelectedDay && f.highlightSelectedDay),
                    ...
                    (f.futureYearsCount = isNaN(f.futureYearsCount) ? 6 : f.futureYearsCount),
                    ...
                    (f.disableHolidays = void 0 !== f.disableHolidays && f.disableHolidays),
                    "string" == typeof t
                        ? (u = $("#" + t))
                        : ((u = $(t)),
                          (t = (function () {
                ...
                h.append("<table class='bd-table' dir='rtl' cellspacing='0' cellpadding='0'></table>"),
                    f.swapNextPrev
                        ? m.append("<button id='bd-prev-" + t + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><span>قبلی</span></button>")
                        : m.append("<button id='bd-next-" + t + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><span>بعدی</span></button>");
                m.append("<div class='bd-dropdown'></div><div class='bd-dropdown'></div>"),
                    m.find(".bd-dropdown:nth-child(2)").append("<select id='bd-month-" + t + "' class='bd-month'></select>"),
                    m.find(".bd-dropdown:nth-child(3)").append("<select id='bd-year-" + t + "' class='bd-year'></select>"),
                    f.swapNextPrev
                        ? m.append("<button id='bd-next-" + t + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><span>بعدی</span></button>")
                        : m.append("<button id='bd-prev-" + t + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><span>قبلی</span></button>");
                var x = $("#bd-next-" + t);
                ...
                var I = $("#bd-month-" + t);
                $.each({ 1: "فروردین", 2: "اردیبهشت", 3: "خرداد", 4: "تیر", 5: "مرداد", 6: "شهریور", 7: "مهر", 8: "آبان", 9: "آذر", 10: "دی", 11: "بهمن", 12: "اسفند" }, function (t, e) {
                ...
                h.find(".bd-table").append("<thead><tr></tr></thead>"),
                    $.each({ شنبه: "ش", یکشنبه: "ی", دوشنبه: "د", "سه شنبه": "س", چهارشنبه: "چ", "پنج شنبه": "پ", جمعه: "ج" }, function (t, e) {
                ...
                function k() {
                    ...
                    ((r = {}).top = a.top < 0),
                    (r.left = a.left < 0),
                    (r.bottom = a.bottom > (window.innerHeight || document.documentElement.clientHeight)),
                    (r.right = a.right > (window.innerWidth || document.documentElement.clientWidth)),
                ...
                function j(t) {
                    var e,
                        ...
                        r,
                        i,
                        d = [-61, 9, 38, 199, 426, 686, 756, 818, 1111, 1181, 1210, 1635, 2060, 2097, 2192, 2262, 2324, 2394, 2456, 3178],
                        l = d.length,
                        s = t + 621,
                        c = -14,
                        p = d[0];
                ...
                function Y(t) {
                    var e, o, n, a;
                    return (
                        (e = (e = 4 * t + 139361631) + 4 * M(3 * M(4 * t + 183187720, 146097), 4) - 3908),
                ...
                var F = function () {
                        ...
                        "" !== t &&
                            ...
                            C.val(parseInt(t[0])),
                            C.trigger("change"),
                            f.highlightSelectedDay && (v.find(".bd-selected-day").removeClass("bd-selected-day"), v.find(".day-" + parseInt(t[2])).addClass("bd-selected-day")));
                    },
                    N = function (t) {
                ...
                (r = p[0]),
                    ...
                    (function (t) {
                        ...
                        for (var e = 0; e < f.pastYearsCount + f.futureYearsCount; e++) {
                            ...
                            C.append($("<option>", { value: t - f.pastYearsCount + e, text: o }));
                        }
                    })(o),
                    C.val(o),
                    (s = _(o, a));
                ...
                var R = function (e, n) {
                    ...
                    for (var l = 1, s = 1; l <= e; ) {
                        ...
                        for (var c = 0; c < 7; c++) {
                            if (1 == l) for (var p = 0; p < n; ) $("#bd-table-days-" + t + " .tr-1").append($("<td>", { class: "bd-empty-cell" })), p++, c++;
                            if (c < 7 && l <= e) {
                ...
                u.parent().on("click", "button.day", function () {
                    ...
                    f.twodigit && (t = N(t)),
                        ...
                        f.highlightSelectedDay && (v.find(".bd-selected-day").removeClass("bd-selected-day"), $(this).addClass("bd-selected-day"));
                }),
                    x.on("click", function () {
